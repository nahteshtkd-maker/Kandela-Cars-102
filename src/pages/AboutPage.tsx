    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        {/* =========================================================
            VISUAL STORY BANNER
        ========================================================== */}
        <section className="relative rounded-3xl overflow-hidden border border-neutral-200 aspect-[4/5] sm:aspect-[16/9] lg:aspect-[21/9] bg-neutral-100 shadow-sm">
          ...
          <div className="absolute bottom-4 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-8 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 sm:gap-5">

            <div>
              <div className="hidden sm:inline-block bg-white/95 backdrop-blur-sm rounded-xl p-3">
                <KandelaLogo size="md" />
              </div>

              <p className="text-white text-xs sm:text-sm mt-1 sm:mt-3 max-w-md font-medium">
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white font-bold text-xs uppercase tracking-wider px-6 py-3 rounded-lg transition-all shadow-lg shadow-red-600/30 flex items-center space-x-2 w-full sm:w-auto justify-center"
            >
